...
const MyProfile = () => {
    const [userData, setUserData] = useState({
        ...
        email: "adarsh@gemail.com",
        phone: "+91 9876543210",
        address: {
            line1: "Hootgalli, Mysore",
        ...
        <div className='max-w-lg flex flex-col gap-2 text-sm'>
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
                    ...
                    {
                        isEdit ?
                            <select className='max-w-20 bg-gray-100' onChange={(e) => setUserData(prev => ({ ...prev, genger: e.target.value }))} value={userData.gender}>
                    ...
                    {
                        isEdit ?
                            <input className='max-w-30 bg-gray-100' type="date" onChange={(e) => setUserData(prev => ({ ...prev, dob: e.target.value }))} value={userData.dob} />
