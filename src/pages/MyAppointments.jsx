        ...
        <div>
            ...
            <div>
                {doctors.slice(0, 2).map((item, index) => (
                    <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b border-zinc-200'>
                        <div key={index}>
                        ...
                        <div className='flex-1 text-sm text-zinc-600'>
                            ...
                            <p className='text-sm mt-1'><span className='text-sm text-neutral-700 font-medium'>Date & Time:</span>07, July, 2025 | 8:30 PM</p>
                        </div>
                        <div></div>
