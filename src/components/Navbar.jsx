        ...
        <div className='flex justify-between items-center py-4 text-sm mb-5 border-b border-b-gray-400'>
            ...
            <ul className='hidden md:flex items-start gap-5 font-medium'>
                <NavLink to="/">
                    ...
                    <hr className='borber-none outline-none h-0.5 font-medium bg-primary w-3/5 m-auto hidden' />
                </NavLink>
                <NavLink to="/doctors">
            ...
            <div className='flex item-center gap-4'>
                {
                    token ?
                        ...
                        <button onClick={() => navigate('/login')} className='bg-primary text-white cursor-pointer px-8 py-3 rounded-full font-light hidden md:block'>Create account</button>
                }
                ...
                <div className={`${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
                    ...
                    <ul className='flex flex-col gap-4 items-center mt-5 text-lg px-5 font-medium'>
